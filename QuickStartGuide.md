...
1. 安装gcc交叉工具链，参考PDK包中的《AnyCloud37E平台用户开发手册》；
...
1. 解压安装SDK包：tar -zxf XXXX_SDK_Vx.xx.tar.gz

2. 进入解压后的SDK根目录：cd ~/AK37E_SDK_Vx.xx
...
1. 编写应用代码
   ...
   参考AK37E_SDK/platform/sample目录下的中间件示例代码进行代码及Makefile编写。
...
SDK完成编译后将在AK37E_SDK_Vx.xx/image目录下生成以下镜像文件：
   * uImage：内核镜像文件；
