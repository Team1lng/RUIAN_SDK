...
run_compile()
{
	...
	if [ "$1" = "313E" ] || [ "$1" = "313e" ];then
		...
		KDIR=/usr/src/linux-headers-5.15.0-94-generic/ 
		CC=/usr/local/arm/arm-anykav500-linux-uclibcgnueabi/usr/bin/arm-anykav500-linux-uclibcgnueabi-
		architecture=arm 
		system=Linux 
		platform_soc=PLATFORM_313E
	elif [ "$1" = "325" ];then
		...
		KDIR=/home/wuhengbin/Ryan_newarea/AK37E_SDK_V1.05_new/os/bd
		CC=/usr/local/arm/arm-anykav500-linux-uclibcgnueabi/usr/bin/arm-anykav500-linux-uclibcgnueabi-
		architecture=arm 
		system=Linux 
