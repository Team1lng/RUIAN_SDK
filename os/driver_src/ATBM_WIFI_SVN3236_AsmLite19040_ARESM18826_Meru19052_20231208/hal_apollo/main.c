...
static int addr_misuse = 0;
module_param(addr_misuse, int, 0644);
...
static char chip_type_str[10] = "6032i";
#elif (PROJ_TYPE < ARES_A)
static char chip_type_str[10] = "6022";
#endif
module_param_string(chip_name, chip_type_str,10, 0644);
void set_chip_type(const char *chip)
{
	if(chip){
