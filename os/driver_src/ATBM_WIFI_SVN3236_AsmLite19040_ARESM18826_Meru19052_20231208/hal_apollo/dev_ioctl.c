...
//	{ATBM_DEV_IO_SET_UPERR_PROCESS_PID,,},
	...
	{ATBM_DEV_IO_SET_RATE_ALL_POWER,atbm_dev_set_txpwr,"ATBM_DEV_IO_SET_RATE_ALL_POWER:-16~16"},
	{-1,NULL,NULL},
...
/*
	...
	???¡ì?D??¡ì?¨¨?¡ì?¨¦?¡§|??¡§??¡ì??dcxo2??¡ì?DD?¡§??¡§o?12??¡ìa??¡§??¡ì??ppm2??¡ìo?¡ì1dcxo????
...
/*
hw_priv->efuse ?????o??????a??€?????????????¨¤1????????????????¡ì?¡ì??efuse??????efuse?¡ì?¡ì?¡ê¡è???o???¨º?¨¨?¡ì?¡ì???¡ì?¡ì????????¡ìC??
...
//	static int read_flag = 0;
	...
	*/
	...
	for(gain_for = 0;gain_for<3;gain_for++)	{
		...
		}else if(prv_deltagain >= 16){//?o?¡ìoy
