...
#define BL_GPIO_PIN 82
#define LCD_RESET_IO 34
//#define RESET_7INCH_LCD 0

#define RESET_INCH_LCD_TYPE 2
...
unsigned long get_peri_pll_freq(void)
{
	...
	if ((pll_od >= 1) && ((pll_n >= 1) && (pll_n <= 12)) && ((pll_m >= 84) && (pll_m <= 254)))
...
int ak_lcd_parameter_parse_dt1(const void *blob, struct ak_fb *fb_dev)
{
	...
	fb_dev->rgb_info->bg_color = fdtdec_get_int(blob, node, "lcd-rgb-bg-color", LCD_RGB_COLOR_GREEN);
...
static void mipi_clk_and_pad_setting(struct ak_fb *fb_dev)
{
	...
	regval |= (((dsi_info->txd0) | (dsi_info->txd1 << 3) | (dsi_info->txd2 << 6) | (dsi_info->txd3 << 9) | (dsi_info->txd4 << 12)) << 17);
		...
		for (j = 0;; j++)
		{
			...
			else if (j == 1)
			{
				...
				/* 0x03 Generic Short WRITE, no parameters Short
				   ...
				   */
				if (data_type == 0x03 || data_type == 0x13 || data_type == 0x23 || data_type == 0x05 || data_type == 0x15)
				{
...
static void rgb_pannel_sharepin_cfg(struct ak_fb *fb_dev)
{
	...
	if (fb_dev->panel_info->bus_width == LCD_RGB_BUS_WIDTH_8BIT)
	{
		...
		regval &= ~((0x3 << 6) | (0x3 << 8) | (0x3 << 10) | (0x3 << 12) | (0x3 << 14) | (0x3 << 16) | (0x3 << 18) | (0x3 << 20) | (0x3 << 22) | (0x3 << 24) | (0x3 << 26) | (0x3 << 28));
		regval |= ((0x1 << 6) | (0x1 << 8) | (0x1 << 10) | (0x1 << 12) | (0x1 << 14) | (0x1 << 16) | (0x1 << 18) | (0x1 << 20) | (0x1 << 22) | (0x1 << 24) | (0x1 << 26) | (0x1 << 28));
		...
		regval &= ~((0x3 << 6) | (0x3 << 8) | (0x3 << 10) | (0x3 << 12) | (0x3 << 14) | (0x1 << 17) | (0x3 << 18) | (0x3 << 20) | (0x3 << 22) | (0x3 << 24) | (0x3 << 26) | (0x3 << 28));
		regval |= ((0x1 << 6) | (0x1 << 8) | (0x1 << 10) | (0x1 << 12) | (0x1 << 14) | (0x0 << 17) | (0x1 << 18) | (0x1 << 20) | (0x1 << 22) | (0x1 << 24) | (0x1 << 26) | (0x1 << 28));
	...
	else if (fb_dev->panel_info->bus_width == LCD_RGB_BUS_WIDTH_16BIT)
	{
		 ...
		 */
		regval = __raw_readl(SHARE_PIN_CFG4_REG);
		regval &= ~((0x3 << 6) | (0x3 << 8) | (0x3 << 10) | (0x3 << 12) | (0x3 << 14) | (0x3 << 16) | (0x3 << 18) | (0x3 << 20) | (0x3 << 22) | (0x3 << 24) | (0x3 << 26) | (0x3 << 28) | (0x3 << 30));
		regval |= ((0x1 << 6) | (0x1 << 8) | (0x1 << 10) | (0x1 << 12) | (0x1 << 14) | (0x1 << 16) | (0x1 << 18) | (0x1 << 20) | (0x1 << 22) | (0x1 << 24) | (0x1 << 26) | (0x1 << 28) | (0x1 << 30));
		__raw_writel(regval, SHARE_PIN_CFG4_REG);

		regval = __raw_readl(SHARE_PIN_CFG5_REG);
		regval &= ~((0x3 << 0) | (0x3 << 2) | (0x3 << 4) | (0x3 << 6) | (0x3 << 8) | (0x3 << 10) | (0x3 << 12));
		regval |= ((0x1 << 0) | (0x1 << 2) | (0x1 << 4) | (0x1 << 6) | (0x1 << 8) | (0x1 << 10) | (0x1 << 12));
		 ...
		 */
		regval = __raw_readl(PAD_DRV_CFG4_REG);
		regval &= ~((0x3 << 6) | (0x3 << 8) | (0x3 << 10) | (0x3 << 12) | (0x3 << 14) | (0x1 << 17) | (0x3 << 18) | (0x3 << 20) | (0x3 << 22) | (0x3 << 24) | (0x3 << 26) | (0x3 << 28) | (0x3 << 30));
		regval |= ((0x1 << 6) | (0x1 << 8) | (0x1 << 10) | (0x1 << 12) | (0x1 << 14) | (0x0 << 17) | (0x1 << 18) | (0x1 << 20) | (0x1 << 22) | (0x1 << 24) | (0x1 << 26) | (0x1 << 28) | (0x1 << 30));
		__raw_writel(regval, PAD_DRV_CFG4_REG);
	...
	else if (fb_dev->panel_info->bus_width == LCD_RGB_BUS_WIDTH_18BIT)
	{
		...
		regval = __raw_readl(SHARE_PIN_CFG4_REG);
		regval &= ~((0x3 << 6) | (0x3 << 8) | (0x3 << 10) | (0x3 << 12) | (0x3 << 14) | (0x3 << 16) | (0x3 << 18) | (0x3 << 20) | (0x3 << 22) | (0x3 << 24) | (0x3 << 26) | (0x3 << 28) | (0x3 << 30));
		regval |= ((0x1 << 6) | (0x1 << 8) | (0x1 << 10) | (0x1 << 12) | (0x1 << 14) | (0x1 << 16) | (0x1 << 18) | (0x1 << 20) | (0x1 << 22) | (0x1 << 24) | (0x1 << 26) | (0x1 << 28) | (0x2 << 30));
		__raw_writel(regval, SHARE_PIN_CFG4_REG);

		regval = __raw_readl(SHARE_PIN_CFG5_REG);
		regval &= ~((0x3 << 0) | (0x3 << 2) | (0x3 << 4) | (0x3 << 6) | (0x3 << 8) | (0x3 << 10) | (0x3 << 12) | (0x3 << 14) | (0x3 << 16));
		regval |= ((0x2 << 0) | (0x1 << 2) | (0x1 << 4) | (0x1 << 6) | (0x1 << 8) | (0x1 << 10) | (0x1 << 12) | (0x1 << 14) | (0x1 << 16));
		__raw_writel(regval, SHARE_PIN_CFG5_REG);
		...
		regval = __raw_readl(PAD_DRV_CFG4_REG);
		regval &= ~((0x3 << 6) | (0x3 << 8) | (0x3 << 10) | (0x3 << 12) | (0x3 << 14) | (0x1 << 17) | (0x3 << 18) | (0x3 << 20) | (0x3 << 22) | (0x3 << 24) | (0x3 << 26) | (0x3 << 28) | (0x3 << 30));
		regval |= ((0x1 << 6) | (0x1 << 8) | (0x1 << 10) | (0x1 << 12) | (0x1 << 14) | (0x0 << 17) | (0x1 << 18) | (0x1 << 20) | (0x1 << 22) | (0x1 << 24) | (0x1 << 26) | (0x1 << 28) | (0x0 << 30));
		__raw_writel(regval, PAD_DRV_CFG4_REG);

		regval = __raw_readl(PAD_DRV_CFG5_REG);
		regval &= ~((0x3 << 0) | (0x3 << 2) | (0x3 << 4) | (0x3 << 6) | (0x3 << 8) | (0x3 << 10) | (0x3 << 12) | (0x3 << 14) | (0x3 << 16));
		regval |= ((0x0 << 0) | (0x1 << 2) | (0x1 << 4) | (0x1 << 6) | (0x1 << 8) | (0x1 << 10) | (0x1 << 12) | (0x1 << 14) | (0x1 << 16));
		__raw_writel(regval, PAD_DRV_CFG5_REG);
	}
	else if (fb_dev->panel_info->bus_width == LCD_RGB_BUS_WIDTH_24BIT)
	{
		...
		regval = __raw_readl(SHARE_PIN_CFG4_REG);
		regval &= ~((0x3 << 6) | (0x3 << 8) | (0x3 << 10) | (0x3 << 12) | (0x3 << 14) | (0x3 << 16) | (0x3 << 18) | (0x3 << 20) | (0x3 << 22) | (0x3 << 24) | (0x3 << 26) | (0x3 << 28) | (0x3 << 30));
		regval |= ((0x1 << 6) | (0x1 << 8) | (0x1 << 10) | (0x1 << 12) | (0x1 << 14) | (0x1 << 16) | (0x1 << 18) | (0x1 << 20) | (0x1 << 22) | (0x1 << 24) | (0x1 << 26) | (0x1 << 28) | (0x1 << 30)); //(0x2<<30)
		__raw_writel(regval, SHARE_PIN_CFG4_REG);

		regval = __raw_readl(SHARE_PIN_CFG5_REG);
		regval &= ~((0x3 << 0) | (0x3 << 2) | (0x3 << 4) | (0x3 << 6) | (0x3 << 8) | (0x3 << 10) | (0x3 << 12) | (0x3 << 14) | (0x3 << 16) | (0x3 << 18) | (0x3 << 20) | (0x3 << 22) | (0x3 << 24) | (0x3 << 26) | (0x3 << 28));
		regval |= ((0x1 << 0) //(0x2<<0)
				   | (0x1 << 2) | (0x1 << 4) | (0x1 << 6) | (0x1 << 8) | (0x1 << 10) | (0x1 << 12) | (0x1 << 14) | (0x1 << 16) | (0x1 << 18) | (0x1 << 20) | (0x1 << 22) | (0x1 << 24) | (0x1 << 26) | (0x1 << 28));
		__raw_writel(regval, SHARE_PIN_CFG5_REG);
		...
		regval = __raw_readl(PAD_DRV_CFG5_REG);
		regval &= ~((0x3 << 0) | (0x3 << 2) | (0x3 << 4) | (0x3 << 6) | (0x3 << 8) | (0x3 << 10) | (0x3 << 12) | (0x3 << 14) | (0x3 << 16) | (0x3 << 18) | (0x3 << 20) | (0x3 << 22) | (0x3 << 24) | (0x3 << 26) | (0x3 << 28));
		regval |= ((0x0 << 0) | (0x1 << 2) | (0x1 << 4) | (0x1 << 6) | (0x1 << 8) | (0x1 << 10) | (0x1 << 12) | (0x1 << 14) | (0x1 << 16) | (0x1 << 18) | (0x1 << 20) | (0x1 << 22) | (0x1 << 24) | (0x1 << 26) | (0x1 << 28));
		__raw_writel(regval, PAD_DRV_CFG5_REG);
		...
		*/
		regval = __raw_readl(SHARE_PIN_CFG4_REG);
		regval &= ~((0x7 << 0) | (0x7 << 3) | (0x7 << 6) | (0x7 << 9) | (0x7 << 12) | (0x7 << 15) | (0x7 << 18) | (0x7 << 21) | (0x7 << 24) | (0x7 << 27));
		regval |= ((0x1 << 0) | (0x1 << 3) | (0x1 << 6) | (0x1 << 9) | (0x1 << 12) | (0x1 << 15) | (0x1 << 18) | (0x1 << 21) | (0x1 << 24) | (0x1 << 27));
		__raw_writel(regval, SHARE_PIN_CFG4_REG);
...
static void rgb_panel_info_cfg(struct ak_fb *fb_dev)
{
	...
	regval |= (((!panel_info->pclk_pol) << 4) | (0x2 << 5) | ((!panel_info->rgb_seq) << 11) | (rgb_info->alarm_full << 14) | (rgb_info->alarm_empty << 24));
	__raw_writel(regval, AK_LCD_TOP_CONFIG);

	/* lcd rgb general info parameter config */
	regval = __raw_readl(AK_LCD_RGB_GEN_INFO);
	regval = ((panel_info->vogate_pol) | (panel_info->vsync_pol << 1) | (panel_info->hsync_pol << 2) | (rgb_info->neg_blank_level << 3) | (rgb_info->pos_blank_level << 11) | (rgb_info->blank_sel << 19) | (rgb_info->dma_mode << 20) | (panel_info->bus_width << 21) | (rgb_info->tpg_mode << 23) | (rgb_info->rgb_even_seq << 24) | (rgb_info->rgb_odd_seq << 27) | (rgb_info->rgb_seq_sel << 30) | (rgb_info->dummy_seq << 31));
	...
	regval &= ~(0xFFFFFF);
	regval |= ((panel_info->tvpw) | (panel_info->thpw << 12));
	__raw_writel(regval, AK_RGB_INTERFACE1);

	regval = __raw_readl(AK_RGB_INTERFACE2);
	regval &= ~(0xFFFFFF);
	regval |= ((panel_info->thd) | (panel_info->thb << 12));
	__raw_writel(regval, AK_RGB_INTERFACE2);

	thlen = panel_info->thpw + panel_info->thb + panel_info->thd + panel_info->thf;
	regval = __raw_readl(AK_RGB_INTERFACE3);
	regval &= ~(0xFFFFFF);
	regval |= ((thlen) | (panel_info->thf << 13));
	...
	regval |= ((rgb_info->v_unit) | (rgb_info->vh_delay_cycle << 1) | (rgb_info->vh_delay_en << 14) | (panel_info->tvd << 15));
	__raw_writel(regval, AK_RGB_INTERFACE6);

	if (rgb_info->v_unit == 0)
	{
		tvlen = panel_info->tvpw + panel_info->tvb + panel_info->tvd + panel_info->tvf;
	}
	else
	{
		tvlen = panel_info->tvb + panel_info->tvd + panel_info->tvf;
	}
	...
	regval &= ~(0x3FFFFF);
	regval |= ((panel_info->height) | (panel_info->width << 11));
...
static void lcdc_rgb_display(struct ak_fb *fb_dev)
{
	...
	regval = __raw_readl(AK_LCD_TOP_CONFIG);
	regval &= ~((0x3 << 7) | (0x3 << 12));
	regval |= ((fb_dev->rgb_input->a_location << 7) | (fb_dev->rgb_input->fmt1 << 8) | (fb_dev->rgb_input->rgb_seq << 12) | (fb_dev->rgb_input->fmt0 << 13));
	__raw_writel(regval, AK_LCD_TOP_CONFIG);

	/* config RGB input size */
	regval = __raw_readl(AK_RGB_SIZE);
	regval &= ~(0x3FFFFF);
	regval |= ((fb_dev->rgb_input->height) | (fb_dev->rgb_input->width << 11));
	__raw_writel(regval, AK_RGB_SIZE);

	/* config RGB input offset */
	regval = __raw_readl(AK_RGB_OFFSET);
	regval &= ~(0x3FFFFF);
	regval |= ((fb_dev->rgb_input->v_offset) | (fb_dev->rgb_input->h_offset << 11));
...
/************************************************************
** 函数说明: 复位时序 7寸两次 新旧都用7寸
** 作者: cyy
** 日期: 2025-07-23 11:42:02
** 参数说明: 
** 注意事项: 
************************************************************/
static void reset_7inch_lcd_pin(void)
{
		printf("cyy:============>ctrl 7INCH_LCD reset  pin gpio34<==============\n");
		int i = 0;
		for(i=0;i<2;i++)
		{
			gpio_direction_output(LCD_RESET_IO, 1);
			gpio_set_pin_level(LCD_RESET_IO, 1);
			mdelay(5);
			gpio_set_pin_level(LCD_RESET_IO, 0);
			mdelay(10);
			gpio_set_pin_level(LCD_RESET_IO, 1);
			mdelay(120);
			mdelay(10);
...
** 注意事项: 
************************************************************/
static void reset_10inch_lcd_pin(void)
{
	//cyy,旧10寸为空
...
** 注意事项: 
************************************************************/
static void reset_new_10inch_lcd_pin(void)
{
	 	printf("cyy:============>ctrl new 10INCH_LCD reset  pin gpio34<==============\n");
		int i = 0;
		for(i=0;i<1;i++)
		{
			gpio_direction_output(LCD_RESET_IO, 1);
...
void lcd_ctrl_init(void *lcdbase)
{
	...
	// 	}
	// }
	//cyy：程序可优化为i<type,这里方便区分使用switch-case结构
	switch (RESET_INCH_LCD_TYPE)
	{
		case 0:
			printf("===================cyy now lcd type is %d=====================",RESET_INCH_LCD_TYPE);
			reset_7inch_lcd_pin();
			break;
		case 1:
			printf("===================cyy now lcd type is %d=====================",RESET_INCH_LCD_TYPE);
