...
*/
//hlf
#define LCD_XRES			480//1280
#define LCD_YRES			272//800
...
#define CONFIG_DEFAULT_MTDPARTS \
    ...
    "64K@0x52000(DTB),1648K@0x62000(KERNEL),128K@0x1fe000(LOGO),2476K@0x21e000(ROOTFS),128k@0x489000(CONFIG),3200K@0x4A9000(USR),2432K@0x7C9000(APP),128K@0xA29000(TUYA),5852K@0xA49000(DATA)\0"\
// #define CONFIG_DEFAULT_MTDPARTS \
